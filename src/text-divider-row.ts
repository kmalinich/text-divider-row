...
import { LitElement, CSSResult, TemplateResult, css, html } from 'lit';
	...
	static get styles(): CSSResult {
		return css`
			...
			.text-divider-left span {
				margin: var(--text-divider-left-margin, 0 0 0 1em);
			}

			.text-divider-right span {
				margin: var(--text-divider-right-margin, 0 1em 0 0);
			}
		`;
	}
}
